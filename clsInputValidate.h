...
//    {
//        return (clsDate::IsDate1AfterDate2(DateTo, DateFrom))
...
//        while (cin.fail())
//        {
//            // With validation on only numbers.
//            cin.clear();
//            cin.ignore(numeric_limits<streamsize>::max(), '\n');
//            // You must include <limits> to write this function.
...
//    }
//
//    static T ReadNumBetween(T from, T to, string ErrorMsg)
//    {
//        T num = ReadNum();
